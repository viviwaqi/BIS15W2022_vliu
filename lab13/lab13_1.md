...
have to make in ggplot first, before plugging into shiny
...
![](lab13_1_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
ui <- fluidPage(    
  ...
  titlePanel("Log 10 Homerange by Locomotion Method"), # give the page a title
