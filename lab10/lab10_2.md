...
p #just making a plot with those specific variables
```
...
Can also just fill by a variable, like taxon, and it makes each bar a diffrent color
...
"angle" tilts the names or each value
